...
BOOL WINAPI DllMain(HINSTANCE Instance, DWORD Reason, LPVOID Reserved)
{
	...
	{
		CreateDirectoryA(("C:\\Thulium"), NULL);
		CreateDirectoryA(("C:\\Thulium\\Logs"), NULL);
		CreateDirectoryA(("C:\\Thulium\\Configs"), NULL);
		CreateDirectoryA(("C:\\Thulium\\Resources"), NULL);
		CreateDirectoryA(("C:\\Thulium\\Resources\\Fonts"), NULL);
	...
	{
		LOG("DETACHING");
		RemoveFontResource("C:\\Thulium\\Resources\\Fonts\\againts.ttf");
	}
	break;
	}
