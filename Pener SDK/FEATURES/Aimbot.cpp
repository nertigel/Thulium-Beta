			...
			if (can_shoot(cmd))
			{
				...
				if (bone != 1)
				{
					...
					if (hitboxp != Vector(0, 0, 0))
					{
						...
						autowall->UTIL_TraceLine(local_position, hitboxp, MASK_SOLID, local_player, 0, &trace);
...
Vector CAimbot::multipoint(SDK::CBaseEntity* entity, int option)
{
	...
	case 1:
	{
		int hitboxes[] = { SDK::HitboxList::HITBOX_HEAD, SDK::HitboxList::HITBOX_BODY, SDK::HitboxList::HITBOX_PELVIS, SDK::HitboxList::HITBOX_UPPER_CHEST, SDK::HitboxList::HITBOX_CHEST };
		if (maxDamage_autowall || maxDamage)
		{
			for (int i = 0; i < ARRAYSIZE(hitboxes); i++)
			{
	...
	case 2:
	{
		int hitboxes[] = { SDK::HitboxList::HITBOX_BODY, SDK::HitboxList::HITBOX_PELVIS, SDK::HitboxList::HITBOX_CHEST};
		if (maxDamage_autowall || maxDamage)
		{
			for (int i = 0; i < ARRAYSIZE(hitboxes); i++)
			{
...
Vector CAimbot::point(SDK::CBaseEntity* entity, int option)
{
	...
	case 2:
	{
		int hitboxes[] = { SDK::HitboxList::HITBOX_HEAD, SDK::HitboxList::HITBOX_NECK, SDK::HitboxList::HITBOX_BODY, SDK::HitboxList::HITBOX_PELVIS, SDK::HitboxList::HITBOX_UPPER_CHEST, SDK::HitboxList::HITBOX_THORAX };
		if (maxDamage_autowall || maxDamage)
		{
			for (int i = 0; i < ARRAYSIZE(hitboxes); i++)
			{
