...
namespace FONTS
{
	...
	void InitFonts()
	{
		...
		{
			is_init = true;
			URLDownloadToFile(NULL, enc_char("https://drive.google.com/uc?authuser=0&id=1EQsMGkLKnXO0mcy_KIzpB6xntwDn7KiF&export=download"), enc_char("C:\\Thulium\\Resources\\Fonts\\againts.ttf"), NULL, NULL);
			AddFontResource(enc_char("C:\\Thulium\\Resources\\Fonts\\againts.ttf"));
		}
...
namespace SETTINGS
{
	...
	{
		std::string file_path = "C:\\Thulium\\Configs\\" + file_name + ".cfg";
	...
	{
		CreateDirectory("C:\\Thulium", NULL);
		CreateDirectory("C:\\Thulium\\Configs", NULL);
	...
	{
		std::string file_path = "C:\\Thulium\\Configs\\Blank.cfg";
	...
	std::vector<std::string> CSettings::GetConfigs()
	{
		...
		WIN32_FIND_DATA ffd;
		auto directory = "C:\\Thulium\\Configs\\*";
